...
# Database — SQLite for local dev, MySQL/MariaDB for cPanel
# Set USE_SQLITE=True in .env for local development
# Set USE_SQLITE=False (or omit) and provide DB_* vars for cPanel/MySQL
if config('USE_SQLITE', default=True, cast=bool):
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='bexchat'),
